...
export const WEAPONS: Record<WeaponId, Weapon> = {
  pistol: {
    ...
    speed: 680, damage: 1, explosive: false, radius: 4, color: "#fde047", ammo: 0,
  },
  machinegun: {
    id: "machinegun", name: "M.GUN", fireDelay: 0.07, pellets: 1, spread: 0.07,
    speed: 760, damage: 1, explosive: false, radius: 3, color: "#fef08a", ammo: 220,
  },
  shotgun: {
    id: "shotgun", name: "SHOTGUN", fireDelay: 0.5, pellets: 6, spread: 0.5,
    speed: 640, damage: 1, explosive: false, radius: 4, color: "#fdba74", ammo: 30,
  },
  rocket: {
    id: "rocket", name: "ROCKET", fireDelay: 0.7, pellets: 1, spread: 0,
    speed: 520, damage: 5, explosive: true, radius: 7, color: "#fb7185", ammo: 12,
  },
};
